      ...
      <section className="relative py-16 md:py-24 bg-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center space-y-6 mb-12">
            <h2 className="font-['Sofia_Pro'] text-3xl md:text-[40px] font-normal text-[#01005B] tracking-wide">
              {title || 'Find something you love.'}
            </h2>
            <p className="font-['Sofia_Pro'] text-[#676869] max-w-2xl mx-auto leading-relaxed text-[15px]">
          ...
          <div className="flex flex-col items-center">
            <Button className="bg-[#01005B] hover:bg-blue-900 text-white px-10 py-6 w-[374px] h-[56px] rounded text-base font-['Sofia_Pro'] tracking-wide flex items-center justify-center gap-2">
              {buttonText || 'Customize Your Outfit'}
            </Button>

            <div className="flex items-center gap-3  px-4 py-2">
              <div className="flex items-center gap-1.5 text-[10px] md:text-xs text-green-600 font-medium">
          ...
          <div className="flex flex-wrap justify-center items-center gap-[10px] my-5 max-w-4xl mx-auto border-t border-gray-100 md:border-none pt-5">
